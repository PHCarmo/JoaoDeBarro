            ...
            <div class="col-md-12">
                <form class="main_form" method="POST" action="./produto">
                    <div class="row">                        
                        ...
                        <div class="col-6">
                            <input class="form-control" placeholder="Descrição" type="text" maxlength="100" name="prd_descricao" value="<%=temp%>" required>
                        </div>
                        <div class="col-3">
                        ...
                        <div class="col-7">
                            <input class="form-control" placeholder="Código de Barras" type="text" maxlength="11" name="prd_codigo_barra" value="<%=temp%>" required>
                        </div>
                        <div class="col-2">
                        ...
                        <div class="col-3">
                            <select class="form-control" name="prd_gpp_id">
                                ...
                                <option value="1" <%= temp.equals("1") ? "selected" : "" %>>Padrão</option>
                                <option value="2" <%= temp.equals("2") ? "selected" : "" %>>Promoção</option>
                        ...
                        <div class="col-3 cat-1">
                            <select class="form-control" name="ctg_id">
                                ...
                                <option value="3" <%= temp.equals("7") ? "selected" : "" %>>Piso Cerâmico</option>
                                <option value="3" <%= temp.equals("8") ? "selected" : "" %>>Piso Vinílico</option>
                                ...
                                <option value="3" <%= temp.equals("14") ? "selected" : "" %>>Rodapé</option>
